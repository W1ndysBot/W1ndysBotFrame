# app/scripts/GiveMeTitle/message_handler.py

import logging
from app.api.message import send_group_msg, send_private_msg
from app.scripts.GiveMeTitle.group_message_handler import GroupMessageHandler
from app.scripts.GiveMeTitle.private_message_handler import PrivateMessageHandler
